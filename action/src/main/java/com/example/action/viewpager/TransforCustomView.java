package com.example.action.viewpager;
...
public class TransforCustomView extends View {
    // 页面切换时的，白色矩形背景的变化参数
    /**
     * 第1页->第2页
     */
    ...
    public TransforCustomView(Context context) {
        super(context);
        init();
    }

    public TransforCustomView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TransforCustomView(Context context, AttributeSet attrs, int defStyle) {
