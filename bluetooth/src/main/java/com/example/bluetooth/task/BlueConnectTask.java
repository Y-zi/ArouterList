package com.example.bluetooth.task;
...
import com.example.bluetooth.util.BluetoothConnector;

public class BlueConnectTask extends AsyncTask<BluetoothDevice, Void, BluetoothSocket> {//连接
