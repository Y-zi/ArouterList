...
import com.yuzi.bluetooth.adapter.BlueListAdapter;
import com.yuzi.bluetooth.bean.BlueDevice;
import com.yuzi.bluetooth.task.BlueAcceptTask;
import com.yuzi.bluetooth.task.BlueConnectTask;
import com.yuzi.bluetooth.task.BlueReceiveTask;
import com.yuzi.bluetooth.util.BluetoothUtil;
import com.yuzi.bluetooth.widget.InputDialogFragment;

@Route(path = "/bluetooth/进入蓝牙管理")
public class BluetoothActivity extends AppCompatActivity implements
        View.OnClickListener, AdapterView.OnItemClickListener,
        CompoundButton.OnCheckedChangeListener, BlueConnectTask.
        BlueConnectListener, InputDialogFragment.InputCallbacks,
        BlueAcceptTask.BlueAcceptListener {
...
//            list.add("ss");
            ...
            if (mBluetooth == null) {
                Toast.makeText(this, "本机未找到蓝牙功能，您的设备可能不支持蓝牙", Toast.LENGTH_SHORT).show();
                finish();
            }
        }
