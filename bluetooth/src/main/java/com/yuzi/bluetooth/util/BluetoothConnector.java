package com.yuzi.bluetooth.util;
...
public class BluetoothConnector {
    ...
    /**
     * @param device         设备信息
     * @param secure         是否应该通过安全的"socket"进行连接
     * @param adapter        Android BT适配器
     * @param uuidCandidates UUID列表。如果为空或空，则使用Serial PP id
     */
    ...
    public BluetoothSocketWrapper connect() throws IOException {
        ...
        if (!success) {
            throw new IOException("无法连接该设备: " + device.getAddress());
        }
