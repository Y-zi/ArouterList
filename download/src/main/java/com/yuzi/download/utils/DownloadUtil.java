...
import com.yuzi.download.BuildConfig;
...
public class DownloadUtil {
    ...
    public static final int STATE_INITIAL = 0;//等待开始未开始
    public static final int STATE_DOWNLOADING = 1;//暂停
    public static final int STATE_PAUSED = 2;//继续
    public static final int STATE_FINISHED = 3;//完成
    public static final int STATE_CANCELED = 4;
    public static final int STATE_FAILED = 5;//重试
    public static final int STATE_REENQUEUE = 6;//超过三个任务等待开始

    final static int TIME_OUT = 5000;//超时
    final static int DEFAULT_TASK_AMOUNT = 3;//默认任务数量
    final static int DEFAULT_THREAD_AMOUNT = 18;//默认线程数量
