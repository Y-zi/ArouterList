package com.example.lazyviewpager.utils;
...
public abstract class LazyFragmentPagerAdapter extends LazyPagerAdapter<Fragment> {
	...
	private static final String taa = "LazyFragmentPagerAdapter";
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		if (fragment != null) {
			if (DEBUG)
				Log.v(taa, "Attaching item #" + itemId + ": f=" + fragment);
	...
	public void destroyItem(ViewGroup container, int position, Object object) {
		...
		if (DEBUG)
			Log.v(taa, "Detaching item #" + getItemId(position) + ": f=" + object + " v=" + ((Fragment) object).getView());
