package com.yuzi.vidoview.adapter;
...
import com.yuzi.common.utils.algorithm.OpenLock;
import com.yuzi.vidoview.R;
...
//        holder.videoView.setVideoURI(Uri.parse("android.resource://" + "com.yuzi.administrator.douyinviewpager" + "/" + videos[position % 5]));
